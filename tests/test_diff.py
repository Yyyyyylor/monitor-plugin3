...
from monitor_plugin3.core.detector.diff import detect_changes
from monitor_plugin3.core.models.item import ChangeType, Item
...
class TestStorageActivity:
    def test_storage_deposit(self) -> None:
        ...
        from monitor_plugin3.core.detector import classify_activity
